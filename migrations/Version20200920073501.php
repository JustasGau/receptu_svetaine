 ...
 */
final class Version20200920073501 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment ADD recipe_id INT NOT NULL, CHANGE post_date date DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE users ADD banned TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment DROP recipe_id, CHANGE date post_date DATETIME NOT NULL');
